// style-javascript.js - CSS MODULE v1.0
// 🖖 Více admirál Jiřík - Kompletní CSS v JavaScriptu
...
(function() {
    ...
    const CONFIG = {
        debug: true,
        styleId: 'hvezdna-databaze-styles',
        autoInject: true
    };
    ...
    function log(message, type = 'info') {
        ...
        console.log(`${emoji} [Style Module] ${message}`);
    }
...
@media (max-width: 480px) {
    ...
    // ========================================
    function injectCSS() {
        log('Zahajuji injekci CSS do DOM...', 'info');

        // Kontrola, zda už style tag existuje
        let styleElement = document.getElementById(CONFIG.styleId);
        
        if (styleElement) {
            log('Style tag již existuje, aktualizuji...', 'info');
            styleElement.textContent = CSS;
        } else {
            log('Vytvářím nový style tag...', 'info');
        ...
        log('CSS úspěšně injektováno!', 'success');
        log(`CSS velikost: ${(CSS.length / 1024).toFixed(2)} KB`, 'info');
    }
    ...
    window.StyleModule = {
        inject: injectCSS,
        remove: () => {
            const styleElement = document.getElementById(CONFIG.styleId);
            if (styleElement) {
                styleElement.remove();
                log('CSS odstraněno z DOM', 'success');
            }
        },
        getCSS: () => CSS,
        getCSSSize: () => `${(CSS.length / 1024).toFixed(2)} KB`,
        version: '1.0'
    };
    ...
    log('═══════════════════════════════════════', 'info');
    log('STYLE MODULE v1.0 - READY', 'success');
    log('═══════════════════════════════════════', 'info');
